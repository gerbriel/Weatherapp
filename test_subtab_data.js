...
async function testSubTabData() {
  try {
      ...
      .select(`
        *,
        crop_varieties:crop_variety_id (
          name,
          common_name,
          crop_categories:crop_category_id (
            name
          )
        )
      `)
    ...
    console.log('\nTest creating an approved and rejected coefficient for demonstration...');
