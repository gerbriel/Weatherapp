...
export const COMPREHENSIVE_CROP_DATABASE: AvailableCrop[] = [
  // Tree Nuts - Enhanced with watering cycles for perennial management
  {
    ...
    kcSchedule: [
      ...
      { startDate: "03-01", endDate: "03-15", kc: 0.55,  description: "Early March bud break" },
      { startDate: "03-16", endDate: "03-31", kc: 0.67,  description: "Late March leaf development" },
      { startDate: "04-01", endDate: "04-15", kc: 0.75,  description: "Early April growth" },
      { startDate: "04-16", endDate: "04-30", kc: 0.84,  description: "Late April development" },
      { startDate: "05-01", endDate: "05-15", kc: 0.89,  description: "Early May rapid growth" },
      { startDate: "05-16", endDate: "05-31", kc: 0.98,  description: "Late May nut development" },
      { startDate: "06-01", endDate: "06-15", kc: 1.02,  description: "Early June peak growth" },
      { startDate: "06-16", endDate: "06-30", kc: 1.07,  description: "Late June peak demand" },
      { startDate: "07-01", endDate: "07-31", kc: 1.11,  description: "July maximum water demand" },
      { startDate: "08-01", endDate: "08-31", kc: 1.11,  description: "August peak water demand" },
    ...
    monthlyKc: [
      ...
      { month: 3,  monthName: "March",     kc: 0.61, description: "Bud break and early leaf development (avg 0.55–0.67)" },
      { month: 4,  monthName: "April",     kc: 0.80, description: "Flowering and initial nut development (avg 0.75–0.84)" },
      { month: 5,  monthName: "May",       kc: 0.94, description: "Rapid vegetative growth (avg 0.89–0.98)" },
      { month: 6,  monthName: "June",      kc: 1.05, description: "Peak nut development (avg 1.02–1.07)" },
      ...
      { month: 9,  monthName: "September", kc: 1.06, description: "Nut maturation and harvest preparation (avg 1.08–1.04)" },
      { month: 10, monthName: "October",   kc: 0.92, description: "Harvest period (avg 0.96–0.88)" },
