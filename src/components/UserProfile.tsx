...
const DeleteAccountButton: React.FC = () => {
  ...
  return (
    <div className="border-2 border-red-300 dark:border-red-700 rounded-lg p-4 bg-red-50 dark:bg-red-900/20">
      ...
      <ul className="text-sm text-red-800 dark:text-red-200 mb-4 list-disc list-inside space-y-1">
      ...
      <p className="text-sm font-medium text-red-900 dark:text-red-100 mb-2">
        Type <span className="font-mono bg-white dark:bg-gray-800 px-2 py-1 rounded">delete my account</span> to confirm:
      </p>
      <input
        type="text"
        value={confirmText}
        ...
        className="w-full px-3 py-2 border border-red-300 dark:border-red-700 rounded-lg mb-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
        disabled={isDeleting}
      />
      
      {error && (
        <div className="mb-4 p-3 bg-red-100 dark:bg-red-900/40 border border-red-400 dark:border-red-600 rounded-lg text-red-800 dark:text-red-200 text-sm">
          {error}
        </div>
      )}
